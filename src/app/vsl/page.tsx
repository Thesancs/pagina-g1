    ...
    <>
      ...
      <div className="bg-background">
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          ...
          <div className="border-y py-3 my-6">
          ...
          <article className="max-w-none text-foreground space-y-6 leading-relaxed text-lg">
            <p>
          ...
          <section className="mt-10">
            ...
            <div className="w-full aspect-video bg-black rounded-lg flex items-center justify-center text-muted-foreground text-sm cursor-pointer group">
